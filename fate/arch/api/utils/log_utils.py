...
def logDtableInstances(LOGGER, data_instances, topk=5, isInstance=True):
    for i, data in enumerate(data_instances.collect()):
        if isInstance == True:
            LOGGER.info("id: {}, value: {}".format(data[0], data[1].features))
        else:
            LOGGER.info("id:{}, value: {}".format(data[0], data[1]))
