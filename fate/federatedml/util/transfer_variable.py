...
class NeighborsSamplingTransferVariable(BaseTransferVariable):
    def define_transfer_variable(self):
        # distirbuted positive samples id
        self.host_sample_ids = Variable(name="NeighborsSamplingTransferVariable.host_sample_ids", auth={'src': "host", 'dst': ['guest']})
        self.guest_sample_ids = Variable(name="NeighborsSamplingTransferVariable.guest_sample_ids", auth={'src': "guest", 'dst': ['host']})   
        self.guest_number = Variable(name="NeighborsSamplingTransferVariable.guest_number", auth={'src': "guest", 'dst': ['host']})
        self.host_number = Variable(name="NeighborsSamplingTransferVariable.host_number", auth={'src': "host", 'dst': ['guest']})
        # distirbuted negative samples id
        self.host_neg_samp_ids = Variable(name="NeighborsSamplingTransferVariable.host_neg_samp_ids", auth={'src': "host", 'dst': ['guest']})
        self.guest_neg_samp_ids = Variable(name="NeighborsSamplingTransferVariable.guest_neg_samp_ids", auth={'src': "guest", 'dst': ['host']})   
        pass

# transfer variables for Network Embedding algorithm
class HeteroNETransferVariable(BaseTransferVariable):
    def define_transfer_variable(self):
        self.paillier_pubkey = Variable(name="HeteroNETransferVariable.paillier_pubkey", auth={'src': "arbiter", 'dst': ['host', 'guest']})
        self.batch_data_index = Variable(name="HeteroNETransferVariable.batch_data_index", auth={'src': "guest", 'dst': ['host']})
        self.host_forward_dict = Variable(name="HeteroNETransferVariable.host_forward_dict", auth={'src': "host", 'dst': ['guest']})
        self.fore_gradient = Variable(name="HeteroNETransferVariable.fore_gradient", auth={'src': "guest", 'dst': ['host']})
        self.guest_gradient = Variable(name="HeteroNETransferVariable.guest_gradient", auth={'src': "guest", 'dst': ['arbiter']})
        self.guest_optim_gradient = Variable(name="HeteroNETransferVariable.guest_optim_gradient", auth={'src': "arbiter", 'dst': ['guest']})
        self.host_loss_regular = Variable(name="HeteroNETransferVariable.host_loss_regular", auth={'src': "host", 'dst': ['guest']})
        self.loss = Variable(name="HeteroNETransferVariable.loss", auth={'src': "guest", 'dst': ['arbiter']})
        self.is_stopped = Variable(name="HeteroNETransferVariable.is_stopped", auth={'src': "arbiter", 'dst': ['host', 'guest']})
        self.batch_info = Variable(name="HeteroNETransferVariable.batch_info", auth={'src': "guest", 'dst': ['host', 'arbiter']})
        self.host_optim_gradient = Variable(name="HeteroNETransferVariable.host_optim_gradient", auth={'src': "arbiter", 'dst': ['host']})
        self.host_gradient = Variable(name="HeteroNETransferVariable.host_gradient", auth={'src': "guest", 'dst': ['arbiter']})
        self.host_prob = Variable(name="HeteroNETransferVariable.host_prob", auth={'src': "host", 'dst': ['guest']})
        self.guest_common_embedding = Variable(name='HeteroNETransferVariable.guest_common_embedding', auth={'src': 'guest', 'dst':['arbiter']})
        self.host_common_embedding = Variable(name='HeteroNETransferVariable.host_common_embedding', auth={'src': 'host', 'dst':['arbiter']})
        self.common_embedding = Variable(name='HeteroNETransferVariable.common_embedding', auth={'src': 'arbiter', 'dst':['host', 'guest']})
        pass
