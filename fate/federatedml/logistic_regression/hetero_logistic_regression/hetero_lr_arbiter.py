    ...
    def fit(self, data_instances=None):
        ...
        while self.n_iter_ < self.max_iter:
            ...
            while batch_index < self.batch_num:
                ...
                LOGGER.info("host data feature dims:{}".format(np.array(host_optim_gradient).shape[0]))
                LOGGER.info("guest data feature dims:{}".format(np.array(guest_optim_gradient).shape[0]))
