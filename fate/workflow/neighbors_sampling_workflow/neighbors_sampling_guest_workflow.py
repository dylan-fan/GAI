...
from federatedml.neighbors_sampling.neighbors_sampling_guest import NeighborsSamplingGuest

LOGGER = log_utils.getLogger()


class NeighborsSamplingGuestWorkFlow(WorkFlow):
    def _initialize_model(self, config_path):
        ...
        self.neighbors_sampler = NeighborsSamplingGuest(self.neighbos_sampling_param)

    def _initialize_role_and_mode(self):
        self.role = consts.GUEST

if __name__ == "__main__":
    guest_wf = NeighborsSamplingGuestWorkFlow()
    guest_wf.run()
